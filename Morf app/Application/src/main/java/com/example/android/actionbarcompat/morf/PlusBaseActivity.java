...
public abstract class PlusBaseActivity extends ActionBarActivity
    ...
    /**
     * Called when the {@link Plus} revokes access to this app.
     */
    ...
    /**
     * Called when the {@link Plus} is disconnected.
     */
    protected abstract void onPlusClientSignOut();

    /**
     * Called when the {@link Plus} is blocking the UI.  If you have a progress bar widget,
    ...
    /**
     * Connect the {@link Plus} only if a connection isn't already in progress.  This will
    ...
    /**
     * Disconnect the {@link com.google.android.gms.common.api.GoogleApiClient} only if it is connected (otherwise, it can throw an error.)
